...
class MusicLibraryController
  ...
  # Initialize with path, instantiate new MusicIimporter object, and import from path
  ...
  # Start CLI and prompt user for input
  def call
    # Welcome user, explain commands
    ...
    # Get input, execute command until "exit"
    user_input = ""
  ...
  # Puts list of songs in numbered, alphabetical list
  def list_songs
